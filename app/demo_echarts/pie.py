...
def render_pie_simple():
    options = {
        "title": {"text": "Data Analyze", "left": "center"},
        "tooltip": {"trigger": "item"},
        "legend": {"orient": "vertical", "left": "left",},
        "series": [
            {
                "name": "Big Data Analyze",
                "type": "pie",
                "radius": "50%",
                "data": [
                    {"value": data['Users'], "name": "Users"},
                    {"value": data['TotalHours'], "name": "Total Player Hours"},
                    {"value": data['AvgHours'], "name": "Avg Player Hours"},
                    {"value": data['LikedGame'], "name": "Player Liked Game"},
                    {"value": data['NotLikedGame'], "name": "Player Not Liked Game"},
